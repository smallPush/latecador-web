...
export const Header: React.FC = () => {
  return (
    <div className="relative w-full h-64 bg-gradient-to-r from-yellow-300 to-orange-300 overflow-hidden">
      ...
      {/* Main Content */}
      <div className="absolute inset-0 flex flex-col justify-center pl-4 md:pl-20 w-2/3">
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left z-20">
            <h1 className="font-script text-5xl sm:text-7xl md:text-9xl text-gray-900 relative transform -rotate-2 drop-shadow-sm leading-none">
              La tecad'or
            </h1>
            <h2 className="text-[#1e40af] tracking-[0.2em] font-bold text-[0.6rem] sm:text-xs md:text-lg mt-2 uppercase font-sans drop-shadow-sm">
              CÀTERING & ESDEVENIMENTS
            </h2>
          </div>
        </div>

        <div className="mt-4 md:mt-8 text-gray-700 font-bold text-sm md:text-lg">
          latecador@gmail.com
        </div>
      </div>
    </div>
