...
export const products: Product[] = [
  {
    ...
    items: [
      ...
      { id: 'croquetes-gamba', name: 'Gamba', price: 1.62, unit: 'unitat' },
    ],
  },
  {
    id: 'empanades',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'pizzes-tonyina', name: 'Tonyina', price: 19.50, unit: 'unitat' },
    ],
  },
  {
    id: 'truites',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'entrepans-mitjans', name: 'Mitjans', price: 2.40, unit: 'unitat' },
      { id: 'entrepans-mitjans-gourmet', name: 'Mitjans gourmet', price: 2.80, unit: 'unitat' },
    ],
  },
  {
    id: 'barquetes',
    ...
    items: [
      ...
      { id: 'barquetes-verdures', name: 'Verdures escalivades', price: 1.20, unit: 'unitat' },
      { id: 'barquetes-tonyina', name: 'Tonyina i gambes', price: 1.20, unit: 'unitat' },
      { id: 'barquetes-pernil', name: 'Pernil ibèric', price: 1.20, unit: 'unitat' },
      { id: 'barquetes-safata', name: 'Safata de 16 unitats', price: 18.00, unit: 'safata' },
    ],
  },
  {
    id: 'safates',
    ...
    items: [
      ...
      { id: 'safates-formatges', name: 'Formatges', price: 65.00, unit: 'safata' },
    ],
  },
  {
    id: 'canapes',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'alfajores-caixa-12', name: 'Caixa de 12 unitats', price: 12.50, unit: 'caixa' },
    ],
  },
  {
    id: 'safata-dolcos',
  ...
  },
  {
    ...
    items: [
      ...
      { id: 'coques-vidre', name: 'Vidre', price: 20.00, unit: 'unitat' },
    ],
  },
  {
    id: 'pionono',
